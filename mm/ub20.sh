...
GITHUB_CMD="http://aa.cemilan-vpn.my.id:81/"
NAMECOM=$(curl -sS https://raw.githubusercontent.com/ayaze01/clash/main/mm/ip | grep $MYIP | awk '{print $2}')
...
FIGHTERTUNNEL() {
    curl -sS https://raw.githubusercontent.com/ayaze01/clash/main/mm/ip >/root/tmp
